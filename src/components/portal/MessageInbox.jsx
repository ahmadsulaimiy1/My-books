...
/*
  MessageInbox
  ------------
  Shared inbox UI (message list + reading pane) used by both the Student
  and Faculty Messages screens — the two were previously hand-duplicated
  as near-identical View components (see Priority 5: "no duplicate
  components"). Both roles' message shape is identical (see
  portalDemoData.js: demoFacultyMessages is documented as "same shape as
  demoMessages"), so this owns the shared interaction once.
*/

import { useState } from 'react';
import { Card } from './ui';

export default function MessageInbox({ messages }) {
