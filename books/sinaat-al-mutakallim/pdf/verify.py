...
ITEMS = [
    ...
    ("ع٢٤", "11", "وقد نجد بعض المهرة", "بعض المهرة في صناعة الإعراب", ["12320"], "نقل عالم في حاشية"),
    ("ع٢٥", "11", "ويسمّونه المعلّم الأوّل", "يعنون معلم صناعة المنطق", ["12320"], "نقل عالم في حاشية"),
    ("ع٢٦", "02", "القوة الموجودة في جنان", "القوة الموجودة في جنان الإنسان", ["2573"], "نقل عالم في حاشية"),
    ("ع٢٧", "10", "أن تكون الكلمة وحشيةً", "أن تكون الكلمة وحشية لا يظهر معناها", ["7380"], "نقل عالم"),
