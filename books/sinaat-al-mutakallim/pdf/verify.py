...
ITEMS = [
    ...
    ("ح١٣", "09", "يرفع بهذا الكتاب أقوامًا", "إن الله يرفع بهذا الكتاب أقواما", MUSLIM, "حديث"),
    ("ح١٤", "09", "الماهرُ بالقرآن", "الماهر بالقرآن مع السفرة الكرام البررة", MUSLIM + BUKHARI, "حديث"),
    ...
    ("ح١٥", "11", "إنّ من البيان لسحرًا", "إن من البيان لسحرا", BUKHARI, "حديث"),
    ...
    ("ع١٦", "13", "الصناعة هي ملكةٌ", "الصناعة هي ملكة في أمر عملي فكري", ["12320"], "نقل عالم في حاشية"),
    ("ع١٧", "13", "والملكات لا تحصل", "والملكات لا تحصل إلا بتكرار الأفعال", ["12320"], "نقل عالم في حاشية"),
    ("ع١٨", "08", "فتحصل له هذه الملكة", "فتحصل له هذه الملكة بهذا الحفظ والاستعمال", ["12320"], "نقل عالم في حاشية"),
    ...
    ("ع٢١", "09", "أيش؟ أصله", "أصله أي شيء لكنه اختصر", ["20562"], "نقل عالم في حاشية"),
    ("ع٢٢", "11", "وأبى جمهور أهل الأدب", "وأبى جمهور أهل الأدب والعلم بلسان العرب", ["236"], "نقل عالم"),
    ("ع٢٣", "05", "جميع ما يحتاج إليه", "جميع ما يحتاج إليه في صنعة الكلام", ["23787"], "نقل عالم"),
    ("ع٢٤", "13", "وقد نجد بعض المهرة", "بعض المهرة في صناعة الإعراب", ["12320"], "نقل عالم في حاشية"),
    ("ع٢٥", "13", "ويسمّونه المعلّم الأوّل", "يعنون معلم صناعة المنطق", ["12320"], "نقل عالم في حاشية"),
    ("ع٢٦", "02", "القوة الموجودة في جنان", "القوة الموجودة في جنان الإنسان", ["2573"], "نقل عالم في حاشية"),
    ("ع٢٧", "12", "أن تكون الكلمة وحشيةً", "أن تكون الكلمة وحشية لا يظهر معناها", ["7380"], "نقل عالم"),
    ("ع٢٨", "06", "فعلى كل مسلمٍ أن يتعلّم", "فعلى كل مسلم أن يتعلم منن لسان العرب", ["8180"], "نقل عالم"),
    ("ع٢٩", "06", "ثم منها ما هو واجبٌ على الأعيان", "ولا يفهم إلا بفهم اللغة العربية", ["11620"], "نقل عالم"),
    ("ع٣٠", "06", "ولسان العرب أوسع الألسنة", "أوسع الألسنة مذهبا", ["8180"], "نقل عالم"),
    ("ع٣١", "06", "خُصّت بها العرب الإعرابُ", "الفارق بين المعاني المتكافئة", ["9977"], "نقل عالم"),
    ("ع٣٢", "06", "لو احتجنا أن نعبّر عن السيف", "نعبر عن السيف وأوصافه", ["9977"], "نقل عالم"),
    ("ع٣٣", "06", "ولذلك نجد كلام العجم", "كلام العجم من مخاطباتهم أطول", ["12320"], "نقل عالم في حاشية"),
    ("ع٣٤", "06", "أركانه أربعة، وهي اللغة", "أركانه أربعة وهي اللغة والنحو", ["12320"], "نقل عالم"),
    ("ع٣٥", "06", "فإذا فرضنا مبتدئًا", "فإذا فرضنا مبتدئا في فهم العربية", ["11435"], "نقل عالم"),
    ("ع٣٦", "06", "حملة العلم في الملّة", "حملة العلم في الملة الإسلامية أكثرهم العجم", ["12320"], "نقل عالم"),
    ("ع٣٧", "06", "وربّما يكون الدؤوب", "وربما يكون الدؤوب على التعليم", ["12320"], "نقل عالم"),
    ("ع٣٨", "07", "وإنّا للقرآن لحافظون", "وإنا للقرآن لحافظون", ["7798"], "نقل مفسّر"),
    ("ع٣٩", "07", "وخشي أهل العلوم", "فينغلق القرآن والحديث على المفهوم", ["12320"], "نقل عالم"),
    ("ع٤٠", "07", "علم القرّاء أن صاحب المعالي", "اقتباس الحروف اللاتينية وبعض الحروف المشابهة", ["29674"], "مصدر معاصر في حاشية"),
    ("ع٤١", "07", "الصعوبة الأصلية أن نعرف", "الصعوبة الأصلية أن نعرف ما يضم", ["29674"], "مصدر معاصر"),
    ("ت٤", "07", "قوبلت بالاستنكار", "قوبلت بالاستنكار والنقض", ["12286"], "ترجمة"),
    ("ع٤٢", "16", "يُعرف الفاعل من المفعول", "فيعرف الفاعل من المفعول والمبتدأ من الخبر", ["12320"], "نقل عالم"),
    ("ع٤٣", "16", "أوسعوا دائرة الكلام فيها", "أوسعوا دائرة الكلام فيها", ["12320"], "نقل عالم"),
    ("ع٤٤", "16", "علومٌ مقصودة بالذات", "علوم مقصودة بالذات كالشرعيات", ["12320"], "نقل عالم"),
    ("ع٤٥", "16", "القدر الذي يُفهم به خطاب العرب", "القدر الذي يفهم به خطاب العرب", ["5459"], "نقل عالم"),
    ("ع٤٦", "16", "لا يُشترط أن يبلغ درجة الخليل", "لا يشترط أن يبلغ درجة الخليل والمبرد", ["5459"], "نقل عالم"),
    ("ع٤٧", "16", "فلا بدّ من أن يبلغ في العربية", "فلا بد من أن يبلغ في العربية مبلغ الأئمة", ["11435"], "نقل عالم"),
    ("ع٤٨", "16", "الرحلة في طلب العلوم", "الرحلة في طلب العلوم ولقاء المشيخة", ["12320"], "نقل عالم"),
    ("و١", "07", "ليس لي علمٌ بالسنسكريتية", "", [], "وثيقة تاريخية"),
    ("و٢", "07", "لم أجد أحدًا منهم", "", [], "وثيقة تاريخية"),
    ("و٣", "07", "الغاية الكبرى للحكومة البريطانية", "", [], "وثيقة تاريخية"),
    ("و٤", "07", "يُخشى أن يُمسّ الدين", "", [], "وثيقة تاريخية"),
    ("ت١", "09", "الفارسيّ، ثم البصري", "بن قنبر الفارسي ثم البصري", ["10906"], "ترجمة"),
    ("ت٢", "09", "كان أصله من البيضاء", "كان أصله من البيضاء من أرض فارس", ["6744"], "ترجمة"),
    ("ت٣", "09", "قريةٌ مجهولةٌ من قرى خوارزم", "قرى خوارزم تسمى زمخشر", ["1000"], "ترجمة"),
    ...
    ("ن١", "90", "فمن الناس من أنكر", "فمن الناس من أنكر أن يكون هذا من شعره", ["7289"], "خريطة نسب القول"),
    ("ن٢", "90", "وقيل إنما قال", "وقيل إنما قال إن البيان لفي الفؤاد وهذا أقرب إلى الصحة", ["8352"], "خريطة نسب القول"),
]
...
SCANS = {
    ...
    "ع٥": ("البيان والتبيين، تحقيق عبد السلام هارون", "١/١٣٨–١٣٩", "https://archive.org/details/20240524_20240524_0853",
           "مطابقٌ حرفًا بحرف"),
    "و١": ("Sharp (ed.), Selections from Educational Records, Part I (Calcutta, 1920)", "p. 109",
           "https://archive.org/details/SelectionsFromEducationalRecordsPartI1781-1839", "Macaulay's Minute, 2 Feb. 1835: «I have no knowledge of either Sanscrit or Arabic»؛ الترجمة للمؤلف"),
    "و٢": ("Sharp (ed.), Selections from Educational Records, Part I (Calcutta, 1920)", "p. 109",
           "https://archive.org/details/SelectionsFromEducationalRecordsPartI1781-1839", "a single shelf of a good European library…؛ الترجمة للمؤلف"),
    "و٣": ("Sharp (ed.), Selections from Educational Records, Part I (Calcutta, 1920)", "pp. 130–131",
           "https://archive.org/details/SelectionsFromEducationalRecordsPartI1781-1839", "Lord Bentinck's Resolution, 7 March 1835, First and Third؛ الترجمة للمؤلف"),
    "و٤": ("W. Spitta-Bey, Grammatik des arabischen Vulgärdialectes von Aegypten (Leipzig, 1880)", "Vorwort, XIV–XV",
           "https://archive.org/details/grammatikdesara00spitgoog", "Man fürchtet, der Religion zu nahe zu treten, wenn man die Sprache des Korans aufgiebt؛ الترجمة للمؤلف"),
}
