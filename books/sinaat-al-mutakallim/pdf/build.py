...
PART_SUMMARIES = {
    ...
    15: ["ثمانية مجلدات: أربع مراحل (ثلاثة، ثم اثنان، ثم واحد، ثم واحد)، ثم المرجع.",
         "كل حدٍّ بين مرحلتين حدٌّ بين مجلدين، ولا يُقطع بابٌ ولا مستوى.",
         "رُدّ نموذج «أربعة كتب × مجلدين» لأنه يفرض التناظر على منهجٍ غير متناظر.",
         "الملكة الباب الثالث عشر، وبنك الأخطاء المرجع الأول مع الملاحق والفهارس العامة.",
         "البنية العلمية ثابتة، والبنية المادية للنشر تابعةٌ لها."],
