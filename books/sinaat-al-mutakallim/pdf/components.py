...
def page_grid(num):
    ...
    return fig(f'<div class="panel">{body}</div>', num,
               "شبكة كتاب الطالب في مقاسه الأول (٢٠×٢٦ سم، ونُسخ بالباب ١١٢ك: المجلدات كلها ١٧×٢٤ سم، وشبكتها في pdf/geometry.py) في صفحتين متقابلتين: الهوامش مرآوية، والعمود الجانبي على الجهة الخارجية.")
