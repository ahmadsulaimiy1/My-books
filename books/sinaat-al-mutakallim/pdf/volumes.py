...
# · ("back", stem) glossary and sources
VOLUMES = [
    ...
    dict(n=2, name="اللسان", stage=1, units=[("bab", 2), ("program",)],
         sentence="صحّة الصوت الذي يحمل الكلام، ثم برنامجٌ يوميٌّ يحفظها ثلاثين يومًا."),
    dict(n=3, name="العبارة", stage=1, units=[("bab", 3)],
    ...
    dict(n=4, name="البيان", stage=1, units=[("bab", 4)],
    ...
    dict(n=7, name="الحوار", stage=2, units=[("bab", 7)],
