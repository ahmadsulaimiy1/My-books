...
def main():
    letter = page("letter-congratulation-dr-habib")
    blank  = page("letterhead")
    ...
    # the crown edge, magnified, clear of both sheets: champagne, then crimson,
    # then sapphire — three plates in register, countable
    px_mm = DPI / 25.4
    box = (int(58*px_mm), int(81*px_mm), int(152*px_mm), int(100*px_mm))
    det = detail(letter, box, 940)
