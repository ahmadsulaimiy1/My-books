...
# the same eleven stops as --foil-gold-dark in materials.css: the mark is
# struck on sapphire, so it takes the ramp cut for a dark ground
FOIL_STOPS = [
    (0.00, "#B08A33"), (0.09, "#E6C878"), (0.19, "#FFF8D8"), (0.27, "#EED08A"),
    (0.38, "#BE9640"), (0.50, "#FBEDBE"), (0.60, "#DABA5C"), (0.72, "#FFFDF4"),
    (0.82, "#E7C877"), (0.92, "#A8802E"), (1.00, "#F4E4AC"),
]
