...
FACES = [
    ...
    # The Arabic faces also carry their own LATIN cut. Arabic copy is full of
    # Latin codepoints - the parentheses around (آل سلام), the slashes in a
    # reference number, an em dash in a folio. Without these the browser drops
    # to a system serif for those glyphs alone, which is visible on the page and
    # embeds Liberation Serif into the PDF.
    ("Amiri",          "family=Amiri:wght@400",                    "latin",      400, None),
    ("Amiri",          "family=Amiri:wght@700",                    "latin",      700, None),
    ("Reem Kufi",      "family=Reem+Kufi:wght@500",                "arabic",     500, {"wght": 500}),
    ("Reem Kufi",      "family=Reem+Kufi:wght@500",                "latin",      500, {"wght": 500}),
    ("Cinzel",         "family=Cinzel:wght@400",                   "latin",      400, {"wght": 400}),
    ("Cinzel",         "family=Cinzel:wght@400",                   "latin-ext",  400, {"wght": 400}),
    ("Cinzel",         "family=Cinzel:wght@500",                   "latin",      500, {"wght": 500}),
    ("Cinzel",         "family=Cinzel:wght@500",                   "latin-ext",  500, {"wght": 500}),
    ("Cinzel",         "family=Cinzel:wght@600",                   "latin",      600, {"wght": 600}),
    ("Cinzel",         "family=Cinzel:wght@600",                   "latin-ext",  600, {"wght": 600}),
    ("Source Serif 4", "family=Source+Serif+4:opsz,wght@8..60,400","latin",      400, {"wght": 400, "opsz": 11}),
    ("Source Serif 4", "family=Source+Serif+4:opsz,wght@8..60,400","latin-ext",  400, {"wght": 400, "opsz": 11}),
]
...
def main():
    ...
    header = """/* ══════════════════════════════════════════════════════════════════════════════
   THE PERSONAL OFFICE — EMBEDDED TYPOGRAPHY
   ...
   font to install and no network request.
     ...
     Amiri          Arabic serif — the scholarly voice, the principal identity
